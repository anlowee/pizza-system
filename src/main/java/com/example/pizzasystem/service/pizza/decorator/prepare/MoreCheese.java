 ...
 * @date 2020/9/14
 */
public class MoreCheese extends Pizza {

    Pizza pizza;

    public MoreCheese(Pizza pizza) {
        this.pizza = pizza;
    ...
    public String prepare() {
        return pizza.prepare() + ", more cheese";
    }
    ...
    @Override
    public Double cost() {
        return pizza.cost() + Menu.getInstance().getMoreCheesePrice();
    }
}
